...
mod test {
    ...
    fn digging_instructions_parse_works(
        ...
        let instructions = DiggingInstructions::parse(&utils::read_file("2023/day18", "test.txt"));
    ...
    fn diggint_instructions_parse_hex_works() {
        let instructions =
            DiggingInstructions::parse_hex(&utils::read_file("2023/day18", "test.txt"));
