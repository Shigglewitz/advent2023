...
mod test {
    ...
    fn test_maze() -> PipeMaze {
        return PipeMaze::parse(&utils::read_file("2023/day10", "test1.txt"));
    }

    fn test_maze_2() -> PipeMaze {
        return PipeMaze::parse(&utils::read_file("2023/day10", "test2.txt"));
    }
    ...
    fn pipe_maze_shoe_lace_tests(#[case] file_name: &str, #[case] expected: i32) {
        let pipe_maze = PipeMaze::parse(&utils::read_file("2023/day10", file_name));
